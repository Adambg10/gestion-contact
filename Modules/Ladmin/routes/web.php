...
use Modules\Ladmin\Http\Controllers\ContactAdminController;
...
use Modules\Ladmin\Http\Controllers\UserController;
...
ladmin()->route(function () {
    ...
    Route::resource('/contact', ContactAdminController::class)->except(['index', 'show']);
